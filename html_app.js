...
// var html_txt = '/views/strap_small.html'
// var area_txt = '/views/text.html'
//
//
// app.get('/',function(req,res){ res.sendFile(path.join(__dirname + html_txt)) });
// app.get('/text',function(req,res){ res.sendFile(path.join(__dirname + area_txt)) });
