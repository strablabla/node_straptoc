...
function initMiniTable(tableId){
    ...
    var tableSettings = { fontSize: 12, headerFontSize: 14, headerStyle: 'bold', colStats: {} }
    ...
    function render(){
        ...
        var $title = $('<span/>').addClass('mini-table-title').css('margin-bottom', '0').text(tableId)
                ...
                if (c === 0 && r > 0){
                    var $td = $('<td/>').text(r)
                                        .css({'font-size': fs + 'px', 'text-align': 'center',
                                              'background-color': '#f5f5f5', 'color': '#888', 'user-select': 'none'})
                    $tr.append($td)
                    continue
                }
