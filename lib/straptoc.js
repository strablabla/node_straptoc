...
function initMiniTable(tableId){
    ...
    function render(){
        ...
        var $settingsBtn = $('<img/>').attr('src', 'capicon/svg/007.svg')
            ...
            .css({'width': '16px', 'height': '16px', 'cursor': 'pointer', 'margin-left': '8px', 'opacity': '0.4'})
            .on('mouseenter', function(){ $(this).css('opacity', '0.8') })
            .on('mouseleave', function(){ $(this).css('opacity', '0.4') })
        ...
        $settingsBtn.click(function(e){
            ...
            // Font size (body)
            var $sizeInput = $('<input/>').attr('type', 'number').attr('min', '8').attr('max', '40').val(tableSettings.fontSize).css('width', '60px')
            ...
            // Font size (header = first row)
            var $headerInput = $('<input/>').attr('type', 'number').attr('min', '8').attr('max', '40').val(tableSettings.headerFontSize).css('width', '60px')
            ...
            // Nb rows
            var $rowsInput = $('<input/>').attr('type', 'number').attr('min', '1').attr('max', '200').val(tableData.length).css('width', '60px')
            ...
            // Nb cols
            var $colsInput = $('<input/>').attr('type', 'number').attr('min', '1').attr('max', '50').val(tableData[0].length).css('width', '60px')
            ...
            $popup.append($close)
                  .append(makeRow('Taille du texte', $sizeInput))
                  .append(makeRow('Taille noms de colonnes', $headerInput))
                  .append(makeRow('Nb lignes', $rowsInput))
                  .append(makeRow('Nb colonnes', $colsInput))
                  .append(makeRow('Première ligne en gras', $boldInput))
            $('body').append($popup)
