...
function initMiniTable(tableId){
    ...
    function render(){
        ...
        var $title = $('<span/>').addClass('mini-table-title').css({'margin-bottom': '0', 'font-size': (tableSettings.titleFontSize || 12) + 'px'}).text(tableId)
