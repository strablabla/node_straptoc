...
function initMiniTable(tableId){
    ...
    var tableSettings = { fontSize: 14, headerFontSize: 14, headerStyle: 'bold', colStats: {} }
    ...
    function render(){
        ...
        for (var r = 0; r < tableData.length; r++){
            ...
            for (var c = 0; c < tableData[r].length; c++){
                var fs = (r === 0 ? tableSettings.headerFontSize
                         : r === tableData.length - 1 ? Math.max(8, tableSettings.fontSize - 2)
        ...
        $colBtns.append($('<button/>').addClass('mini-table-btn-inline').text('\u2212').click(function(){
        ...
        $tdBtns.append($('<button/>').addClass('mini-table-btn-inline').text('\u2212').click(function(){
            if (tableData.length > 1){
                tableData.pop()
                render(); save()
            }
        }))
        $tdBtns.append($('<button/>').addClass('mini-table-btn-inline').css('margin-left', '3px').text('+').click(function(){
